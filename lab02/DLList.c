...
void DLListBefore (DLList L, char *it)
{
	...
	// inserting an item before the first item
	    new->next = L->curr;
	    L->curr->prev = new;
	    L->curr = new;
	    L->first = new;
	...
	// inserting an item before current 
	// when current is after first
	    new->next = L->curr;
...
void DLListAfter (DLList L, char *it)
{
	...
	// inserting an item after current
	// when current is before last
